...
MD
  ...
  set +e
  O38=$(HARNESS_TICKET_WARN_MB=1 bash _harness/scripts/harness-status.sh 2>&1); O38_RC=$?
  set -e
  ...
  set +e
  O38c=$(HARNESS_TICKET_WARN_MB=1000000 bash _harness/scripts/harness-status.sh 2>&1)
  set -e
