...
rs_fixture() {
  ...
  cp -r Tickets/999912Z-PROJ-99999 "$a"
  ...
  cp -r Tickets/999912Z-PROJ-99999 "$b"
  ...
  cp -r Tickets/999912Z-PROJ-99999 "$c"
  mv "$c/999912Z-PROJ-99999.md" "$c/202605A-PROJ-3.md"
  python3 _harness/scripts/append_notebook_cell.py "$c/Checks/checks_master.ipynb" \
...
rs_counts() {
  ...
  set +e
  R85_OUT=$(HARNESS_WORK_ROOT="$R85" bash _harness/scripts/retro_stats.sh); R85_RC=$?
  set -e
  [ "$R85_RC" -eq 0 ] \
